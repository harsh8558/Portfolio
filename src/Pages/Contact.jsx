...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      <div
        className="h-auto py-10 flex items-center justify-center px-[5%] "
        id="Contact"
      >
        <div className="container px-[1%] md:px-[7.5%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          <div
            data-aos="fade-right"
